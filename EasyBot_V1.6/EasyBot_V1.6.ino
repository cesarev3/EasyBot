...
void varredura30() { // varredura de distancia
  torre30();
  delay(200);
  medirDistancia();
  medida30 = distancia;
...
void varredura150() { // varredura de distancia
  torre150();
  delay(200);
  medirDistancia();
  medida150 = distancia;
...
void modoAutonomo () { // modo Autonomo
  ...
  if(varreduraCont == 10 || varreduraCont == 22) {
    varredura30();
  }

  if(varreduraCont == 12 || varreduraCont == 20) {
    varredura150();
  }

  if(medidaCentro < 20 || distanciaAbaixo < 20) {
    parado();
    varreduraParado();
    varreduraCont = -1;

    if(medida0 > 19 && medida180 > 19) {
    ...
    if(medida0 < 20 && medidaCentro < 20 && medida180 < 20) {
      atrasApenas();
      delay(1500);
      parado();
      varreduraParado();
      if(medida180 > medida0) {
        atrasEsquerda();
        delay(1400);
        parado();
        torreCentro();
  ...
  if(medidaCentro > 19 && distanciaAbaixo > 19) {
    frenteApenas();
    medirDistanciaAbaixo();

    if(medida30 < 35 && distanciaAbaixo > 19) {
      frenteDireita();
      delay(300);
      medida30 = 100;
    }
    if(medida150 < 35 && distanciaAbaixo > 19) {
      frenteEsquerda();
      delay(300);
      medida150 = 100;
    }
